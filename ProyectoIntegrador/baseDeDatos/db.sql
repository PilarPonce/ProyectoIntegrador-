...
INSERT INTO productos
VALUES (DEFAULT, 'El psiconalista', '/images/productos/thriller1.png', 2002, ' John Katzenbach', 'Thriller', 'El psicoanalista es una novela de suspenso y psicología, la cual cuenta lo que vive el Doctor Frederick Starks después de recibir una carta amenazadora en la que le indican que debe suicidarse, o de lo contrario en quince días matarían poco a poco a todos los miembros de su familia.', 3, DEFAULT, DEFAULT);
INSERT INTO productos
