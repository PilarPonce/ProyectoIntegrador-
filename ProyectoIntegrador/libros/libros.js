let libros = {
    ...
    },
    {
        ...
        anio: 2020,
        resumen: "Elísabet Benavent regresa al panorama de la literatura con una novela que explora el significado del éxito en la vida y reflexiona con ironía y humor acerca de las imposiciones sociales, la presión del grupo y la autoexigencia que, aunque cueste creerlo, no es sinónimo de felicidad. Los lectores han dicho...¡Un libro magnífico. Adictivo! Una historia real, bien escrita. He reído, llorado, suspirado. Elísabet, he leído todos tus libros y, aunque parezca imposible, sigues sorprendiéndome. Una historia madura que nos hace reflexionar. No es una novela al uso centrada en el amor de pareja, es eso y mucho más. Leer a Elísabet es entrar en la historia, sentirla y vivirla. Su pluma te atrapa. Te puede gustar un libro más que otro. Amar a un personaje y odiar a otros... pero siempre tienen algo que te marca y que se queda incrustado en el corazón.",
        comentarios: [{usuario: "Kylie Jenner", comentario : "Excelente novela, como siempre, la autora nos tiene acostumbrados a la perfección en redacción!"},
        {usuario: "Khloe Kardashian", comentario : "Me encantó este libro, me lo leí en dos días. "},
        {usuario: "Kendall Jenner", comentario : "Me sorprendió, pensé que sería como los otros libros de la autora, pero éste está mejor desarrollado, es menos predecible que otros que he leído de ella, me gustó bastante."},
        {usuario: "Kris Jenner", comentario : " Intrigante, fácil de leer y contado de una manera muy cinematográfica, lo cual hace que te enganches muchísimo. "},
        {usuario: "Kourtney Kardashian", comentario : "Este catalogo es buenisimo, me encanta"}]
    },
    {
    ...
    clasicos: [{
            id: 5,   
            tipo: "clasicos",
            genero:"Novela filosofica y literatura infantil",
            nombre: "El principito",
            foto: "/images/productos/clasicos1.jpg",
            autor: " Antoine de Saint-Exupéry",
            anio: 1943,
            resumen: " El principito es un cuento poético que viene acompañado de ilustraciones hechas con acuarelas por el mismo Saint-Exupéry.11​ En él, un piloto se encuentra perdido en el desierto del Sahara después de que su avión sufriera una avería, pero para su sorpresa, es allí donde conoce a un pequeño príncipe proveniente de otro planeta. La historia tiene una temática filosófica, donde se incluyen críticas sociales dirigidas a la «extrañeza» con la que los adultos ven las cosas. Estas críticas a las cosas «importantes» y al mundo de los adultos van apareciendo en el libro a lo largo de la narración.",
            comentarios: [{usuario: "Kylie Jenner", comentario : "Excelente novela, como siempre, el autor nos tiene acostumbrados a la perfección en redacción!"},
            {usuario: "Khloe Kardashian", comentario : "Me encantó este libro, me lo leí en dos días. "},
            {usuario: "Kendall Jenner", comentario : "Me sorprendió, pensé que sería como los otros libros de el autor, pero éste está mejor desarrollado, es menos predecible que otros que he leído de ella, me gustó bastante."},
            {usuario: "Kris Jenner", comentario : " Intrigante, fácil de leer y contado de una manera muy cinematográfica, lo cual hace que te enganches muchísimo. "},
        ...
        },
        {
            ...
            foto: "/images/productos/clasicos2.jpg",
            autor: "Jane Austen",
            anio: 1813,
            resumen: " La señora Bennet ha criado a sus cinco hijas con el único deseo de encontrar marido. La llegada al vecindario de Charles Bingley, un joven rico y soltero, con algunas amistades despierta el interés de las hermanas Bennet y de las familias vecinas, que verán una excelente oportunidad para cumplir su propósito. Elizabeth, una de las hijas de los Bennet, empezará una singular relación con Darcy, uno de los amigos de Bingley, que desencadenará esta historia de orgullo y prejuicios entre los dos hasta llegar a conocer el verdadero amor. ",
            comentarios: [{usuario: "Kylie Jenner", comentario : "Excelente novela, como siempre, la autora nos tiene acostumbrados a la perfección en redacción!"},
            {usuario: "Khloe Kardashian", comentario : "Me encantó este libro, me lo leí en dos días. "},
            {usuario: "Kendall Jenner", comentario : "Me sorprendió, pensé que sería como los otros libros de la autora, pero éste está mejor desarrollado, es menos predecible que otros que he leído de ella, me gustó bastante."},
            {usuario: "Kris Jenner", comentario : " Intrigante, fácil de leer y contado de una manera muy cinematográfica, lo cual hace que te enganches muchísimo. "},
        ...
        ficcion: [
        {
            id: 9,   
            tipo: "ficcion",
            genero:"Ficcion, literatura infantil",
            nombre: "Animales fantásticos: Los crímenes de Grindelwald",
            foto: "/images/productos/ficcion1.jpg",
            autor: " J. K. Rowling",
            anio: 2018,
        ...
        },
        {
            ...
            genero:"Ficcion",
            nombre: "Bruja verde",
            foto: "/images/productos/ficcion3.jpg",
            autor: "Arin Murphy-Hiscock",
            anio: 2019,
            resumen: "La bruja verde es una herborista sabia que abraza el poder de la naturaleza y emplea plantas, flores, aceites y hierbas para sanar. Siempre acude al mundo natural en busca de orientación, y respeta a todas y cada una de las criaturas vivientes, por pequeñas que sean.",
            comentarios: [{usuario: "Kylie Jenner", comentario : "Excelente novela, como siempre, la autora nos tiene acostumbrados a la perfección en redacción!"},
            {usuario: "Khloe Kardashian", comentario : "Me encantó este libro, me lo leí en dos días. "},
            {usuario: "Kendall Jenner", comentario : "Me sorprendió, pensé que sería como los otros libros de la autora, pero éste está mejor desarrollado, es menos predecible que otros que he leído de ella, me gustó bastante."},
            {usuario: "Kris Jenner", comentario : " Intrigante, fácil de leer y contado de una manera muy cinematográfica, lo cual hace que te enganches muchísimo. "},
        ...
        },
        {
            ...
            nombre: "Dracula",
            foto: "/images/productos/ficcion4.jpg",
            autor: "Arin Murphy-Hiscock",
            anio: 1897,
            resumen: "Drácula es la creación literaria más famosa del vampirismo. Contenido: El abogado Jonathan Harker descubre que, en el castillo del conde Drácula, este se comporta por las noches como un vampiro. Harker sigue a Drácula a Inglaterra, donde el conde busca nuevas víctimas, entre ellas, a Mina, la prometida de Harker.",
            comentarios: [{usuario: "Kylie Jenner", comentario : "Excelente novela, como siempre, la autora nos tiene acostumbrados a la perfección en redacción!"},
            {usuario: "Khloe Kardashian", comentario : "Me encantó este libro, me lo leí en dos días. "},
            {usuario: "Kendall Jenner", comentario : "Me sorprendió, pensé que sería como los otros libros de la autora, pero éste está mejor desarrollado, es menos predecible que otros que he leído de ella, me gustó bastante."},
            {usuario: "Kris Jenner", comentario : " Intrigante, fácil de leer y contado de una manera muy cinematográfica, lo cual hace que te enganches muchísimo. "},
        ...
        },
        {
            ...
            autor: "Mercedes Ron",
            anio: 2020,
            resumen: "Kami Hamilton tenía doce años cuando le dieron su primer beso: desde entonces los labios de Thiago Franco, el hermano de su mejor amigo Taylor, la persiguen en sueñospero nunca en la realidad. Los dos hermanos hace seis años que desaparecieron de su vida sin dejar rastro hasta ahora. Los hermanos han regresado y el mundo aparentemente perfecto de Kamilah se tambalea. Ella ya no es la niña inocente que conocieron: ahora es la más popular del instituto, donde la llaman la reina de cristal porque nunca deja entrever ningún sentimiento. Es perfecta y parece que nadie, ni siquiera su novio, puede acceder realmente a ella. Nadie excepto Thiago. ¿Podrá resistirse Kami a la simple presencia de Thiago? ¿La perdonará él por lo que sucedió cuando solo eran unos niños?",
            comentarios: [{usuario: "Kylie Jenner", comentario : "Excelente novela, como siempre, la autora nos tiene acostumbrados a la perfección en redacción!"},
            {usuario: "Khloe Kardashian", comentario : "Me encantó este libro, me lo leí en dos días. "},
            {usuario: "Kendall Jenner", comentario : "Me sorprendió, pensé que sería como los otros libros de la autora, pero éste está mejor desarrollado, es menos predecible que otros que he leído de ella, me gustó bastante."},
            {usuario: "Kris Jenner", comentario : " Intrigante, fácil de leer y contado de una manera muy cinematográfica, lo cual hace que te enganches muchísimo. "},
