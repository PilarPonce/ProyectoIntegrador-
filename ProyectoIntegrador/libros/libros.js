let libros = {
    bestsellers:[ {
        ...
        comentarios: [{usuario: "user 1", comentario : "Excelente novela, como siempre, es que Javier nos tiene acostumbrados a la perfección en redacción!"},
        {usuario: "user 2", comentario : "Me encantó este libro, me lo leí en dos días. "},
        {usuario: "user 3", comentario : "Me sorprendió, pensé que sería como los otros libros de Javier Castillo, pero éste está mejor desarrollado, es menos predecible que otros que he leído de éste autor, me gustó bastante."},
